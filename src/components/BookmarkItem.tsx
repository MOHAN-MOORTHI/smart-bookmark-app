...
export default function BookmarkItem({ bookmark }: BookmarkItemProps) {
    ...
    return (
        <div className="group relative bg-gray-900/50 border border-gray-800 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 hover:-translate-y-1 backdrop-blur-sm">
            <div className="flex justify-between items-start">
                ...
                <button
                    ...
                    className="opacity-0 group-hover:opacity-100 p-2 text-gray-500 hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-all duration-200 focus:opacity-100"
